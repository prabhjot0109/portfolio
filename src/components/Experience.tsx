  ...
  const timelineEvents = [
    {
      ...
      highlights: [
        "Designed and led an AI-based soil evaluation system for rural families",
        "Integrated vision-based crop disease detection with 92% accuracy",
        "Awarded the IEEE Tech4Good Grant for innovation and social impact",
        "Deployed a scalable AI pipeline for real-time crop insights",
      ],
      status: "completed",
      color: "orange",
    },
