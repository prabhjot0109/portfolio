          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4 max-w-6xl mx-auto">
            {[
              ...
              <motion.div
                ...
                className="portfolio-card p-4 text-center hover:shadow-lg transition-all duration-300 cursor-pointer group"
              >
                <div className="w-10 h-10 mx-auto mb-2 group-hover:scale-110 transition-transform duration-200">
                  <img 
                    src={tech.logo} 
                    alt={tech.name}
